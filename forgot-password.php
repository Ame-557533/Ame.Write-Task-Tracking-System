...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($user) {
            // TODO: Wire up PHPMailer / Mailgun to send a real reset link
            // $token = bin2hex(random_bytes(32));
            // store token, email link...
        }
...
<div class="auth-page">
  ...
  <div class="auth-card">
    ...
    <?php else: ?>
    <a href="login.php" class="btn-primary" style="text-align:center;margin-top:.5rem;text-decoration:none;">
      Back to sign in
    </a>
    <?php endif; ?>
  </div>
